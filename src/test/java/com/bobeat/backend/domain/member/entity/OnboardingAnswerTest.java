...
class OnboardingAnswerTest {
    ...
    void 유효한_질문_번호와_옵션으로_올바른_답변을_찾을_수_있다(int questionNumber, int selectedOption, String expectedAnswer) {
        // when
    ...
    void 유효하지_않은_질문_번호나_옵션으로_예외가_발생한다(int questionNumber, int selectedOption) {
        // when & then
    ...
    @Test
    void Q4_이인분_도전_답변은_1점3배_가중치가_적용된다() {
        // given  
    ...
    @Test
    void Q5_중요도_답변은_1점0배_가중치가_적용된다() {
        // given
    ...
    void 점수_구간에_따라_올바른_레벨을_반환한다(double totalScore, Level expectedLevel) {
        // when
