...
public class QReview extends EntityPathBase<Review> {
    ...
    private static final long serialVersionUID = 1589416447L;
    ...
    public final com.bobeat.backend.domain.store.entity.QStore store;
    ...
    public QReview(Class<? extends Review> type, PathMetadata metadata, PathInits inits) {
        ...
        this.store = inits.isInitialized("store") ? new com.bobeat.backend.domain.store.entity.QStore(forProperty("store"), inits.get("store")) : null;
    }
