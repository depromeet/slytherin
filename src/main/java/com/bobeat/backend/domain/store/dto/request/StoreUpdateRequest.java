...
@Schema(description = "어드민 가게 수정 요청 DTO")
public record StoreUpdateRequest(
    ...
    @Schema(description = "가게 이미지 수정 요청 DTO")
    ...
    @Schema(description = "좌석 옵션 수정 요청 DTO")
    public record SeatOptionUpdateRequest(
